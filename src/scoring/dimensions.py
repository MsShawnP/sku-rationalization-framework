...
def score_velocity(uspw: float) -> int:
...
def score_contribution_margin(loaded_margin_pct: float) -> int:
...
def score_shelf_space_cost(annual_cost: float) -> int:
...
def score_production_complexity(complexity_ratio: float) -> int:
